...
HD_PWD='D:/Xilinx_Vivado_projects/dig_clock_stu_1/dig_clock_stu_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dig_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dig_clock.tcl -notrace
