...
HD_PWD='D:/Xilinx_Vivado_projects/dig_clock_stu_1/dig_clock_stu_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dig_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dig_clock.tcl
